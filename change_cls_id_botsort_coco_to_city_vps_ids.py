...
bs_cv_path='/home/subha/Videos/Paper1_results/directly_from_nws/BoT_SORT/city_vps_val_img_BoT_SORT_labels'
bs_ks_path='/home/subha/Videos/Paper1_results/directly_from_nws/BoT_SORT/kitti_step_Bot_SORT_labels'
bs_w_path='/home/subha/Videos/Paper1_results/directly_from_nws/BoT_SORT/waymo_val_Bot_SORT_labels'
...
for i,file in enumerate(ks_l):
    ...
    for ss in lines:
        ...
        print(line)
        sid=file.split('.')[0]
        fid=int(line[0]) - 1 #for track_eval frames start from 0
        tid=line[1]
