...
plots_folder = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'data', 'plots_subha','trackers_comparison_on_a_dataset'))
...
dataset = os.path.join('city_kitti_mots', 'city_vps_mots')
...
dataset = os.path.join('city_kitti_mots', 'kitti_step_mots')
data_fol = os.path.join(tracker_folder, dataset)
trackers = os.listdir(data_fol)
out_loc = os.path.join(plots_folder, dataset)
for cls in classes:
...
dataset = os.path.join('city_kitti_mots', 'waymo_mots')
data_fol = os.path.join(tracker_folder, dataset)
trackers = os.listdir(data_fol)
out_loc = os.path.join(plots_folder, dataset)
for cls in classes:
