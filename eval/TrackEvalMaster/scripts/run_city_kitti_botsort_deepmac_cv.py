...
if __name__ == '__main__':
    ...
    script_config = {
        ...
        'BENCHMARKS': ['city_vps_mots'],#'kitti_step_mots'],  # If None, use all for each split.
        ...
        'TRACKERS_TO_EVAL':['botsort_deepmac'],
    }
    ...
    if not config['BENCHMARKS']:
        if config['CK_SPLIT'] == 'val':
            config['BENCHMARKS'] = ['city_vps_mots','kitti_step_mots']
