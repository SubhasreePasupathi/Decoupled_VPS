...
deep_path="/home/subha/Videos/Paper1_results/directly_from_nws/deepmac/cityscapes_vps_deepmac/policy_03_CLOSEST CENTER/deepmac_instance_tracking_masks"
...
class write_line:
    ...
    def __init__(self,sid,fid,tid,cid,conf,h,w,mask):
        ...
        write_path='track_eval_format_full_panid'
...
for i,file in enumerate(ll):
    ...
    for j,ss in enumerate(lines):
        ...
        write_line(sid,fid-1,cls*1000+tid,cls,conf,im.size[1],im.size[0],rle.decode('UTF-8'))
