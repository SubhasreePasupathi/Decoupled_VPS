...
path='pcan_track_result_mask_val_kitti_step_with_bdd_pcan_cat_ids'
l=os.listdir(path)
l.sort()
...
for i,fol in enumerate(l):
    ...
    for j,img_name in enumerate(ll):
        ...
        for ins_id in ins_ids:
            ...
            write_line(sid,j,obj_id,bdd_to_city[class_id],str('1'),img.size[1],img.size[0],rle.decode('UTF-8'))
