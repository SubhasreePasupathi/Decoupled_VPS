...
if __name__ == '__main__':
    ...
    psp_root="/home/malx470/Music/city_vps_val_sseg_pred_mask_fol"
    pcan_root="/home/malx470/Pictures/bs_dm/bs_dm_cv"
    ...
    for psp_path,pcan_path in (zip(psp_paths,pcan_paths)):
        res_fol=os.path.join("/home/malx470/Pictures/mask_merge/sseg_bs_dm_cv/",pcan_path.split('/')[-2])
        Path(res_fol).mkdir(parents=True,exist_ok=True)
