...
if __name__ == '__main__':
    ...
    psp_root="/waymo_pspnet/gray"
    pcan_root="/pcan_track_result_mask_val_waymo_with_bdd_pcan_cat_ids"
    ...
    for psp_path,pcan_path in (zip(psp_paths,pcan_paths)):
        res_fol=os.path.join("/home/subha/Videos/mask_merge/waymo/",'result',pcan_path.split('/')[-2])
